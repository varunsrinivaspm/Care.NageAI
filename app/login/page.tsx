    ...
    <div className="fixed inset-0 bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 flex items-center justify-center p-4 z-[200]">
      ...
      <div className="relative w-full max-w-sm">
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-slate-400 text-sm mt-2 text-center">Your personal AI health intelligence platform</p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 shadow-2xl p-8">
          ...
          <p className="text-slate-400 text-sm text-center mb-8">Sign in to access your personalised health dashboard</p>
